...
- Check Mode tests do not contact Meraki for authorative responses on validity of plays. Check mode will always report changed for a play, regardless of configuration in Meraki.
options:
    auth_key:
        description:
